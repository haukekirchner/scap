#!/bin/bash
#SBATCH --job-name=scap_gtx1080_profiler-torch_batch-size-128
...
# Run the script.
python -u train.py -l /scratch1/users/hgronen/torch-log/${SLURM_JOB_NAME}_${SLURM_JOB_ID} -t False -p True -d False -b 128
