...
\ac{FLOPS} can be used to evalute the models efficiency.
...
As "most of modern hardware architectures uses FMA instructions for operations with tensors.  FMA computes $a*x+b$ as one operation. Roughly $GMACs = 0.5 * GFLOPs$"%\footnote{\url{https://github.com/sovrasov/flops-counter.pytorch/issues/16#issuecomment-518585837}, , accessed on: 22.11.2022}.
