...
The code for pre-training the poinet model can be found in the accompanying github repository~\url{https://github.com/haukekirchner/scap/, accessed on: 22.02.2023}.
