...
Table~\Cref{tab:metrics} shows an overview of the most important metrics which were used for profiling the PyTorch workflow. Traditionally software is profiled by analyzing execution time and \acf{FLOPs}. With the advent of \ac{GPU}'s throughput and \ac{MACs} gained importance.
