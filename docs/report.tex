...
What is the benefit of using different accelerators? What is the cost of using profilers?

Therefore, the three presented tools~(\Cref{sec:tools-overview}) were tested on all available \ac{GPU}s of the Scientific Compute Cluster\footnote{\tiny{\url{https://www.gwdg.de/web/guest/hpc-on-campus/scc}}}.
