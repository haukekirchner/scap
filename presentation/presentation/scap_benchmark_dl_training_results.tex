...
\begin{frame}{Trying to use the PyTorch Profiler to find the reason}
    \begin{center}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{../../data/scap_gtx1080_profiler-torch_sample-points_14628864}
    \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{Effect of sample points}
    \begin{center}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{../../data/sacct_barplot_by_nodes_sample-points-effect}
    \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{result of increasing batch size}
    \begin{center}
        \begin{figure}
            \includegraphics[width=1\textwidth]{../../data/sacct_barplot_by_nodes_batch-size-effect}
